...
<script>
  export default {
    data () {
      return {
        message:`
<html lang="zh-cn" style="font-size: 99.4667px;"><head>
<meta charset="utf-8"/>
...
<meta content="Cleam Lee" name="author"/>
<meta content="东方新闻,看点新闻,今日看点,东方网,今日新闻,今日东方新闻" name="keywords"/>
<meta content="东方新闻网-东方网旗下《东方新闻》是一款会自动学习的资讯软件,它会分析你的兴趣爱好,为你推荐喜欢的内容,并且越用越懂你.就要你好看,东方新闻网!" name="description"/>
<title>魔术强森沒有后悔辞去总裁职务,澄清离开与詹皇没关系</title>

<link href="https://mini.eastday.com/toutiaoh5/css/photoswipe/photoswipe.min.css" rel="stylesheet"/>
<link href="https://mini.eastday.com/toutiaoh5/css/common.min.css" rel="stylesheet"/>
<link href="https://mini.eastday.com/toutiaoh5/css/page_details_v5.min.css" rel="stylesheet"/>
</head><body><iframe height="0" src="//m.tt.cn/setuid.html?u=15549161463275659" style="display: none;" width="0"></iframe><style id="diigolet-chrome-css" type="text/css">body#dummybodyid .diigolet,body#dummybodyid .diigolet a,body#dummybodyid .diigolet em,body#dummybodyid .diigolet span,body#dummybodyid .diigolet div,body#dummybodyid .diigolet dl,body#dummybodyid .diigolet dt,body#dummybodyid .diigolet dd,body#dummybodyid .diigolet ul,body#dummybodyid .diigolet ol,body#dummybodyid .diigolet li,body#dummybodyid .diigolet h1,body#dummybodyid .diigolet h2,body#dummybodyid .diigolet h3,body#dummybodyid .diigolet h4,body#dummybodyid .diigolet h5,body#dummybodyid .diigolet h6,body#dummybodyid .diigolet pre,body#dummybodyid .diigolet form,body#dummybodyid .diigolet fieldset,body#dummybodyid .diigolet p,body#dummybodyid .diigolet blockquote,body#dummybodyid .diigolet th,body#dummybodyid .diigolet td,body#dummybodyid .diigolet input,body#dummybodyid .diigolet textarea,body#dummybodyid .diigolet select,body#dummybodyid .diigolet *{background:transparent none;padding:0;margin:0;flex-direction:row;border:#000 0 solid;text-align:left;text-decoration:none;text-transform:none;text-indent:0;line-height:normal;word-break:normal;word-wrap:normal;width:auto;height:auto;color:inherit;font:inherit;float:none;cursor:default;position:static;overflow:visible;max-width:none;box-shadow:none;opacity:1;border-radius:0;}
...
<input id="newstype" type="hidden" value="tiyu"/>
<input id="datetime_forapp" type="hidden" value="2019-04-22 20:41"/>
<input id="artH" type="hidden" value="19940857"/>
<article class="J-article article" id="J_article">
<div id="title">
<div class="article-title">
<h1>车载智能系统日趋同质化 自主品牌能否“弯道超车”？</h1>
</div>
<div class="article-src-time">
<span class="src">2019-11-17 22:11:27    每日经济新闻</span>
</div>
</div>
<div class="J-article-content article-content" id="content">
<!--导语-->
<p class="section txt">每经记者：孙桐桐    每经编辑：段思瑶</p>
<p class="section txt">当前，在汽车产业智能网联化的发展趋势下，车载智能系统几乎成为所有车型的标配。</p>
<p class="section txt">麦肯锡预测，2025年智能汽车的市场规模将达到1.9万亿美元。美国咨询机构IHF预测，到2035年，全球智能汽车销量将突破1000万辆。摩根斯坦利估算，未来自动驾驶汽车60%的价值将来自于软件。</p>
<p class="section txt">由于自主品牌和跨国汽车公司在智能网联领域几乎位于同一起跑线上，所以汽车的智能网联化被自主品牌视为“弯道超车”的机会。</p>
<p class="section txt">在车载智能系统领域，“土生土长”的自主品牌占据先发优势，率先推出“互联网汽车”产品，引爆行业新需求。随着市场规模不断扩大，合资品牌也开始发力入局。不过，当前车载智能系统竞争日趋同质化，先人一步的自主品牌想要以此为亮点实现“弯道超车”或许并不容易。</p>
<p class="section txt"><strong>车机陷入同质化僵局</strong></p>
<p class="section txt">软件定义汽车的时代已经到来，智能汽车市场蕴含着巨大商机。作为智能汽车的“大脑”，车载智能系统成为各家的必争之地。当前，市面上并没有一套完整且成熟的车机系统解决方案，车企、互联网巨头、科技公司都在加紧布局，力争在智能汽车市场中分得一杯羹。</p>
<p class="section txt">在激战正酣的智能网联市场，BAT（百度、阿里、腾讯）显示出了异于常人的热情。百度建立了以DuerOS为技术底座的车联网系统小度车载OS；阿里和上汽投资的斑马基于AliOS系统打造了“斑马智行”；腾讯和长安合资成立了“梧桐车联”。</p>
<p class="section txt">尽管各家车企搭载的车机系统名称不同，但功能却十分类似，大多包含以下功能：语音识别、语音交互、云服务、OTA（空中下载技术）升级、实时地图导航、组队出行、海量曲库以及社交功能等等。</p>
<p class="section txt">车载智能系统正面临“千机一面”的同质化困境。随着软件迭代速度的提升，创新者最多只能领先几个月，随后就会被竞争者“模仿”，并快速在整个行业内普及。这是智能汽车的发展速度，也反应出智能网联系统正在日趋同质化。</p>
<p class="section txt">由于车载智能系统十分复杂，车企需要与不同领域的供应商合作。在一些关键功能上，实力较强的供应商只有少数一两家，不可避免地造成了功能体验上的同质化。比如，科大讯飞是当前国内语音交互领域的佼佼者，而主流车企几乎都与它建立了合作关系。</p>
<p class="section txt"><strong>自主品牌寻求“突围”</strong></p>
<p class="section txt">随着车载智能系统同质化问题日益突显，自主品牌在这一领域的先发优势正在被蚕食。</p>
<p class="section txt">有分析认为，自主品牌在智能网联方面具备竞争优势，因为国内消费者习惯的互联网生态环境，与外资品牌总部所在地有很大差异。比如，要打通车联网生态，需要一个超级账户把生活的方方面面串联起来，而这一生态在国内是非常完整的。这使得自主品牌在车载智能系统上占有先发优势。</p>
<p class="section txt">例如，上汽和阿里联手打造的汽车行业第一款互联网汽车荣威RX5热销后，随即引发行业普遍追随。如今，合资品牌也开始发力，与BAT合作打造车机系统，并加速产品落地。</p>
<p class="section txt">有机构预测，由于商业利益的驱动，合资品牌正在加快与中国互联网、科技企业的合作。合资品牌智能网联项目的落地，可能会再次给自主车企带来较大冲击。</p>
<p class="section txt">自主品牌也意识到了这一危机，正在采取措施为未来铺路，比如独立开发一套车机系统以形成差异化竞争。</p>
<p class="section txt">例如，吉利汽车研发了GKUI吉客智能车载系统并升级迭代推出GKUI 19，可以接入BAT多种生态；上汽大通旗下车型MAXUS D60除了搭载斑马智行系统外，还提供上汽大通独立开发的车联网系统“蜘蛛智联”。</p>
<p class="section txt">“在互联网汽车刚兴起时，斑马只服务于上汽系车企，而现在面向更多车企开放业务，这样一来，我们的差异化优势逐渐被弱化了。”上汽大通“蜘蛛智联”相关负责人告诉《每日经济新闻》记者，如果车企拥有自己的车联网系统，可以更灵活地打造差异化产品，从而提升市场竞争力。</p>
<p class="section txt">每日经济新闻</p>
<div id="Status"></div>
</div>
</article>
<div id="news_check">
<div class="interest-news" id="J_interest_news"><div class="in-list" id="J_in_list" style="position:relative;padding:0;"></div></div>
<div class="hot-news" id="J_hot_news"></div>
</div>
